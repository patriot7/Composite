...
\
!initfs.o,a3;!mpool.o,a3;!trans.o,a6;!sm.o,a4;!l.o,a1;!te.o,a3;!eg.o,a4;!buf.o,a5;!bufp.o, ;!rotar.o,a7;!!tor_res.o,a8;!va.o,a2;!vm.o,a1:\
c0.o-llboot.o;\
...
ccv_rs.o-sm.o|buf.o|bufp.o|print.o|te.o|fprr.o|mm.o|va.o|mpool.o;\
vm.o-fprr.o|print.o|mm.o|l.o|boot.o;\
va.o-fprr.o|print.o|mm.o|l.o|boot.o|vm.o;\
rotar.o-sm.o|fprr.o|print.o|mm.o|buf.o|bufp.o|l.o|eg.o|va.o|initfs.o;\
tor_res.o-sm.o|fprr.o|buf.o|bufp.o|mm.o|eg.o|va.o|l.o|print.o|rotar.o|ccv_rs_.o;\
